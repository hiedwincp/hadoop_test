...
public class ConvertCustFolderToSeq extends Configured implements Tool {
...
//			}
	...
	public int run(String[] args) throws IOException {
		JobConf jobConf = new JobConf(ConvertCustFolderToSeq.class);
		...
		// SequenceFileOutputFormat.setOutputCompressorClass(jobConf,
		// GzipCodec.class);
	...
	public static void main(String[] args) throws Exception {
		int exitCode = ToolRunner.run(new ConvertCustFolderToSeq(), args);
